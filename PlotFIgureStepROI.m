...
SaveNameFigure = 'Step_ROI_Run08_2017-02-08';
stack_path{1,1} = ['/home/ljp/Science/Projects/RLS/Data/2017-02-08/Run 08/Analysis/StepROIRun08RGB.tif']; % stack of .tif images
stack_path{1,2} = ['/home/ljp/Science/Projects/RLS/Data/2017-02-08/Run 08/Analysis/StepROIRun08LeftRGB.tif'];
stack_path{1,3} = ['/home/ljp/Science/Projects/RLS/Data/2016-12-07/Run 01/Analysis/SineROIRun01_2016-12-07.tif'];
stack_path{1,4} = ['/home/ljp/Science/Projects/RLS/Data/2016-12-07/Run 01/Analysis/SineROIRun01_2016-12-07Left.tif'];
FigureName{1} = 'Run 08 (08-02-2017) Left';
stack_path{2,1} = ['/home/ljp/Science/Projects/RLS/Data/2017-02-08/Run 08/Analysis/StepROIRun08RGB.tif']; % stack of .tif images
stack_path{2,2} = ['/home/ljp/Science/Projects/RLS/Data/2017-02-08/Run 08/Analysis/StepROIRun08RightRGB.tif'];
stack_path{2,3} = ['/home/ljp/Science/Projects/RLS/Data/2016-12-07/Run 01/Analysis/SineROIRun01_2016-12-07.tif'];
stack_path{2,4} = ['/home/ljp/Science/Projects/RLS/Data/2016-12-07/Run 01/Analysis/SineROIRun01_2016-12-07Right.tif'];
FigureName{2} = 'Run 08 (08-02-2017) Right';
ExpSaturation{1} = 0.05;
...
%     hold on;
    ...
    %% Phase Map Z-Projection
    %%%%%%%%%%% WARNING: format paper? %%%%%%%%%%%
    subplot(SBLineNb,SBColumnNb,2+3*(Exp-1):3+3*(Exp-1));
    imgZProj = imread(stack_path{Exp,1});
    imgZProj = imgZProj(:,:,1:3);
    im2 = image(imgZProj(CT:height-CB,CL:width-CR,:))  
    hold on;
    imgZProjROI = imread(stack_path{Exp,3});
    imgZProjROI_2 = cat(3, imgZProjROI*0,imgZProjROI*0, imgZProjROI);
    im3 = image(imgZProjROI_2(CT:height-CB,CL:width-CR,:));
    im3.AlphaData = max(imgZProjROI_2(CT:height-CB,CL:width-CR,:), [], 3)*2;
    axis off;
    ...
    hold on;
    imgXProjROI = imread(stack_path{Exp,4});
    imgXProjROI_2 = cat(3, imgXProjROI*0,imgXProjROI*0, imgXProjROI);
    im3 = image(imrotate(imgXProjROI_2(:,CT:height-CB,:), -90));
    im3.AlphaData = max(imrotate(imgXProjROI_2(:,CT:height-CB,:), -90), [], 3)*2;
    axis off;
...
% Nextcloud
saveas(F1, ['/home/ljp/Nextcloud/ForGeoffrey/Manuscript/Migault et al/CurrentBiologyReviewed/Figure_3/Raw', '/', SaveNameFigure, '.fig']);
saveas(F1, ['/home/ljp/Nextcloud/ForGeoffrey/Manuscript/Migault et al/CurrentBiologyReviewed/Figure_3/Raw', '/',  SaveNameFigure], 'svg');
%%
