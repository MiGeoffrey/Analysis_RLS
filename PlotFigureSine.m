...
for br = 1:size(BrainRegions, 2)
    ...
    for layer = 1:Zs
        ...
        CountourBrainRegionsStack{br, Zs-layer+1} = bwboundaries(img_br);
...
for layer = layerSelected
    ...
    axis off
    for br = 1:size(BrainRegions, 2)
        for i = 1:size(CountourBrainRegionsStack{br,layer},1)
